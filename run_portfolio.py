...
def _is_nan(x):
    """NaN-safe check that doesn't require importing pandas/numpy explicitly."""
    try:
  ...
  # Week 12: Apr 20-24, 2026 -----------------------------------------------
{
  ...
  # Week 14: May 4-8, 2026 -----------------------------------------------
{
    'week_num': 14,
    'start_date': datetime(2026, 5, 4),
    'end_date': datetime(2026, 5, 8),
    'portfolios': {
        'ChatGPT':  [{"stock": "NVDA", "weight": 25},{"stock": "TSLA", "weight": 20},{"stock": "AMD", "weight": 15},{"stock": "META", "weight": 15},{"stock": "COIN", "weight": 10},{"stock": "PLTR", "weight": 10},{"stock": "SMCI", "weight": 5}],
        'Grok':     [{"stock": "NVDA", "weight": 30},{"stock": "AMD", "weight": 25},{"stock": "PLTR", "weight": 20},{"stock": "MU", "weight": 15},{"stock": "SMCI", "weight": 10}],
        'DeepSeek': [{"stock": "ARM", "weight": 20},{"stock": "PLTR", "weight": 20},{"stock": "SHOP", "weight": 20},{"stock": "NVDA", "weight": 20},{"stock": "MU", "weight": 20}],
        'Claude AI':[{"stock": "NVDA", "weight": 20},{"stock": "META", "weight": 15},{"stock": "AMZN", "weight": 15},{"stock": "TSLA", "weight": 12},{"stock": "MSFT", "weight": 10},{"stock": "AMD", "weight": 10},{"stock": "GOOGL", "weight": 8},{"stock": "LLY", "weight": 5},{"stock": "CRWD", "weight": 3},{"stock": "COIN", "weight": 2}]
      }
   },
  # Week 15: May 11-15, 2026 -----------------------------------------------
{
    'week_num': 15,
    'start_date': datetime(2026, 5, 11),
    'end_date': datetime(2026, 5, 15),
    'portfolios': {
        'ChatGPT':  [{"stock": "NVDA", "weight": 25},{"stock": "PLTR", "weight": 20},{"stock": "TSLA", "weight": 20},{"stock": "SMCI", "weight": 15},{"stock": "AMD", "weight": 10},{"stock": "COIN", "weight": 10}],
        'Grok':     [{"stock": "NVDA", "weight": 30},{"stock": "AMD", "weight": 25},{"stock": "MU", "weight": 20},{"stock": "AMAT", "weight": 15},{"stock": "PLTR", "weight": 10}],
        'DeepSeek': [{"stock": "NVDA", "weight": 20},{"stock": "AMD", "weight": 20},{"stock": "INTC", "weight": 15},{"stock": "CSCO", "weight": 15},{"stock": "BABA", "weight": 10},{"stock": "RGTI", "weight": 10},{"stock": "PLUG", "weight": 10}],
        'Claude AI':[{"stock": "ALTO", "weight": 18},{"stock": "STRL", "weight": 18},{"stock": "LSCC", "weight": 15},{"stock": "TSM", "weight": 15},{"stock": "AMZN", "weight": 12},{"stock": "CRWD", "weight": 10},{"stock": "MPC", "weight": 7},{"stock": "INDV", "weight": 5}]
      }
  },
  # Week 16: May 18-22, 2026 -----------------------------------------------
{
    'week_num': 16,
    'start_date': datetime(2026, 5, 18),
    'end_date': datetime(2026, 5, 22),
    'portfolios': {
        'ChatGPT':  [{"stock": "NVDA", "weight": 18},{"stock": "MSFT", "weight": 16},{"stock": "AAPL", "weight": 14},{"stock": "AMD", "weight": 12},{"stock": "TSLA", "weight": 10},{"stock": "AMZN", "weight": 10},{"stock": "META", "weight": 10},{"stock": "SMCI", "weight": 10}],
        'Grok':     [{"stock": "NVDA", "weight": 35},{"stock": "AMD", "weight": 25},{"stock": "MU", "weight": 20},{"stock": "AMAT", "weight": 10},{"stock": "SMCI", "weight": 10}],
        'DeepSeek': [{"stock": "RXT", "weight": 30},{"stock": "CATX", "weight": 25},{"stock": "NVDA", "weight": 20},{"stock": "RGTI", "weight": 15},{"stock": "LRCX", "weight": 10}],
        'Claude AI':[{"stock": "NVDA", "weight": 20},{"stock": "CRWD", "weight": 15},{"stock": "ISRG", "weight": 12},{"stock": "MPC", "weight": 12},{"stock": "TXN", "weight": 10},{"stock": "FIX", "weight": 10},{"stock": "COCO", "weight": 8},{"stock": "ENVA", "weight": 8},{"stock": "ONTO", "weight": 8},{"stock": "NTRS", "weight": 7}]
       }
   },
  # Week 17: May 25-30, 2026 -----------------------------------------------
{
    'week_num': 17,
    ...
    'portfolios': {
        ...
        'DeepSeek': [{"stock": "MU", "weight": 20},{"stock": "RGTI", "weight": 15},{"stock": "NVDA", "weight": 15},{"stock": "ANET", "weight": 12},{"stock": "MP", "weight": 10},{"stock": "INOD", "weight": 10},{"stock": "RXT", "weight": 8},{"stock": "VRT", "weight": 5},{"stock": "KEYS", "weight": 5}],
        'Claude AI':[{"stock": "NVDA", "weight": 20},{"stock": "PLTR", "weight": 15},{"stock": "AVGO", "weight": 15},{"stock": "AMZN", "weight": 12},{"stock": "MSFT", "weight": 12},{"stock": "PODD", "weight": 10},{"stock": "RXT", "weight": 8},{"stock": "MU", "weight": 8}]
      }
   },
  # Week 18: Jun 1-5, 2026 -----------------------------------------------
{
    'week_num': 18,
    'start_date': datetime(2026, 6, 1),
    'end_date': datetime(2026, 6, 5),
    'portfolios': {
        'ChatGPT':  [{"stock": "NVDA", "weight": 25},{"stock": "MSFT", "weight": 20},{"stock": "AAPL", "weight": 15},{"stock": "AMZN", "weight": 15},{"stock": "META", "weight": 15},{"stock": "TSLA", "weight": 10}],
        'Grok':     [{"stock": "NVDA", "weight": 35},{"stock": "AMD", "weight": 25},{"stock": "MU", "weight": 20},{"stock": "SMCI", "weight": 10},{"stock": "MRVL", "weight": 10}],
        'DeepSeek': [{"stock": "NVDA", "weight": 25},{"stock": "AVGO", "weight": 20},{"stock": "MU", "weight": 15},{"stock": "MSFT", "weight": 15},{"stock": "MRVL", "weight": 12},{"stock": "HPE", "weight": 8},{"stock": "DELL", "weight": 5}],
        'Claude AI':[{"stock": "NVDA", "weight": 20},{"stock": "ARKO", "weight": 15},{"stock": "BRSP", "weight": 15},{"stock": "META", "weight": 12},{"stock": "LXFR", "weight": 10},{"stock": "XOM", "weight": 10},{"stock": "MTLS", "weight": 8},{"stock": "AMZN", "weight": 10}]
      }
   },
  # Week 19: Jun 8-12, 2026 -----------------------------------------------
{
    'week_num': 19,
    'start_date': datetime(2026, 6, 8),
    'end_date': datetime(2026, 6, 12),
    'portfolios': {
        'ChatGPT':  [{"stock": "NVDA", "weight": 25}, {"stock": "MRVL", "weight": 20}, {"stock": "AVGO", "weight": 15}, {"stock": "MU", "weight": 15}, {"stock": "ARM", "weight": 10}, {"stock": "DELL", "weight": 10}, {"stock": "PLTR", "weight": 5}],
        'Grok':     [{"stock": "NVDA", "weight": 35}, {"stock": "AMD", "weight": 25}, {"stock": "MU", "weight": 20}, {"stock": "SMCI", "weight": 10}, {"stock": "MRVL", "weight": 10}],
        'DeepSeek': [{"stock": "ORCL", "weight": 25}, {"stock": "ADBE", "weight": 20}, {"stock": "CRWD", "weight": 15}, {"stock": "MU", "weight": 15}, {"stock": "AMD", "weight": 15}, {"stock": "TQQQ", "weight": 10}],
        'Claude AI':[{"stock": "NVDA", "weight": 20}, {"stock": "PLTR", "weight": 15}, {"stock": "AVGO", "weight": 15}, {"stock": "AMZN", "weight": 12}, {"stock": "MSFT", "weight": 12}, {"stock": "BTSG", "weight": 8}, {"stock": "MTLS", "weight": 6}, {"stock": "LXFR", "weight": 6}, {"stock": "ARKO", "weight": 4}, {"stock": "CASH", "weight": 2}]
       }
   },
  # Week 20: Jun 15-19, 2026 -----------------------------------------------
{
    'week_num': 20,
    'start_date': datetime(2026, 6, 15),
    'end_date': datetime(2026, 6, 19),
    'portfolios': {
        'ChatGPT':  [{"stock": "NVDA", "weight": 22},{"stock": "PLTR", "weight": 18},{"stock": "AMD", "weight": 15},{"stock": "CRWD", "weight": 13},{"stock": "HOOD", "weight": 12},{"stock": "RKLB", "weight": 10},{"stock": "SMCI", "weight": 10}],
        'Grok':     [{"stock": "NVDA", "weight": 35},{"stock": "AMD", "weight": 25},{"stock": "MU", "weight": 20},{"stock": "SMCI", "weight": 10},{"stock": "MRVL", "weight": 10}],
...
def fetch_stock_data():
    ...
    for symbol in sorted(all_stocks):
        try:
            ...
            # Pre-clean the close series: drop rows where Close is NaN (halted/bad ticks)
            # so a single bad print from Yahoo can't poison every day after it.
            valid_close = hist['Close'].dropna()
            # Empty/delisted responses can come back with a plain Index instead of a
            # DatetimeIndex, which has no .strftime — guard against that case.
            valid_index = valid_close.index.strftime('%Y-%m-%d') if not valid_close.empty else []

            prices, last_known = [], None
            missing_days = []
            for td in all_trading_days:
                ds = td.strftime('%Y-%m-%d')
                m  = [i for i, d in enumerate(valid_index) if d == ds]
                if m:
                    p = round(float(valid_close.iloc[m[0]]), 2)
                    last_known = p
                elif last_known is not None:
                    p = last_known   # carry forward — no fresh/valid data for this trading day yet
                    missing_days.append(ds)
                elif not valid_close.empty:
                    p = round(float(valid_close.iloc[0]), 2)
                else:
                    p = 100.0   # no valid closes at all for this symbol in range
                prices.append(p)
            if missing_days:
                print(f'⚠️  {symbol:15s} | no fresh close for: {", ".join(missing_days)} (forward-filled)')
            # Final safety net: guarantee no NaNs slip through into prices at all
            for i, p in enumerate(prices):
                if _is_nan(p):
                    fallback = next((prices[j] for j in range(i-1, -1, -1) if not _is_nan(prices[j])), 100.0)
                    prices[i] = fallback
...
def generate_html(llm_results, stock_data, all_trading_days):
    ...
    # ── May-1 baseline: find index of first trading day >= May 1, 2026 ──
    MAY_1 = datetime(2026, 5, 1)
    may_idx = next((i for i, d in enumerate(all_trading_days) if d >= MAY_1), None)

    # Slice labels and values from May-1 onwards
    if may_idx is not None:
        date_labels_may = [d.strftime('%b %d') for d in all_trading_days[may_idx:]]
        # Re-normalise each series so its value at may_idx == $1000
        def rebase(values, idx):
            base = values[idx] if values[idx] > 0 else 1
            return [round(v / base * INITIAL_INVESTMENT, 2) for v in values[idx:]]
        sp500_prices     = stock_data['^GSPC']['prices']
        sp500_may_base   = sp500_prices[may_idx] if sp500_prices[may_idx] > 0 else 1
        sp500_norm_may   = [round((p / sp500_may_base) * INITIAL_INVESTMENT, 2) for p in sp500_prices[may_idx:]]
        sp500_ret_may    = round((sp500_prices[-1] / sp500_may_base - 1) * 100, 2)
    else:
        date_labels_may  = date_labels
        sp500_norm_may   = []
        sp500_ret_may    = 0
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  body{font-family:'Inter','Segoe UI',sans-serif;background:#fff;min-height:100vh;padding:0;}
  .container{max-width:100%;margin:0 auto;background:#fff;overflow:hidden;}
  .header{background:radial-gradient(ellipse at center,#1a2f72 0%,#1e3a8a 50%,#4c1d95 100%);color:#fff;padding:40px 32px 32px;text-align:center;position:relative;overflow:hidden;}
    ...
    <div class="section-title" style="justify-content:space-between;flex-wrap:wrap;gap:10px;">
      ...
      <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
        ...
        <select id="baseline-select" onchange="switchBaseline(this.value)" style="font-family:Inter,sans-serif;font-size:.88em;font-weight:600;color:#1e3a8a;background:#fff;border:2px solid #6366f1;border-radius:8px;padding:6px 12px;cursor:pointer;outline:none;box-shadow:0 1px 4px rgba(99,102,241,.15);">
          <option value="feb">Feb 1 — Start of competition</option>
          <option value="may" selected>May 1 — Recent performance</option>
        </select>
      </div>
    </div>
...
'''
    ...
    # Defense-in-depth: never let a stray NaN (e.g. a bad/delisted price that
    # slipped through) reach the bar-height math and crash html generation.
    def _safe_num(x, fallback=0.0):
        return fallback if _is_nan(x) else x

    sp_fv      = _safe_num(sp500_normalized[-1])
    sp_sign    = '+' if sp500_ret_pct >= 0 else ''
    sp_clr     = '#1e293b'
    all_bars   = list(ranked) + [('S&P 500', {'final_value': sp_fv, 'total_return_pct': sp500_ret_pct})]
    max_val    = max(_safe_num(item[1]['final_value']) for item in all_bars) or 1
    max_bar_px = 240
    for i, (name, data) in enumerate(ranked):
        fv     = _safe_num(data['final_value'])
        trp    = _safe_num(data['total_return_pct'])
        clr    = bar_colors[i]
...
'''
    ...
    # ── Build Feb-baseline series (existing) ─────────────────────────
    feb_series = []
    ...
    feb_series.append({
        ...
        'color': '#1e293b',
        'dates': date_labels,
        'values': sp500_normalized,
        'ret_pct': sp500_ret_pct,
        'is_sp': True
    })

    # ── Build May-baseline series ─────────────────────────────────────
    may_series = []
    if may_idx is not None:
        for i, (llm_name, data) in enumerate(ranked):
            cv_full = data['cumulative_values']
            rebased = rebase(cv_full, may_idx)
            may_ret = round((rebased[-1] / INITIAL_INVESTMENT - 1) * 100, 2)
            may_series.append({
                'name': llm_name,
                'color': colors[i],
                'dates': date_labels_may,
                'values': rebased,
                'ret_pct': may_ret
            })
        may_series.append({
            ...
            'color': '#1e293b',
            'dates': date_labels_may,
            'values': sp500_norm_may,
            'ret_pct': sp500_ret_may,
            'is_sp': True
        })
...
// ── Feb baseline data ──────────────────────────────────────────────
var febData = {_json.dumps(feb_series)};

// ── May baseline data ──────────────────────────────────────────────
var mayData = {_json.dumps(may_series)};

var currentAnnotations = [];

function buildAnnotations(seriesArr) {{
  var allSeries = [];
  for (var i=0; i<seriesArr.length; i++) {{
    var s = seriesArr[i];
    var lastVal = s.values[s.values.length-1];
    var sign = s.ret_pct >= 0 ? '+' : '';
    var label = s.name+': $'+Math.round(lastVal)+' ('+sign+s.ret_pct.toFixed(1)+'%)';
    allSeries.push([lastVal, label, s.color]);
  }}
  allSeries.sort(function(a,b){{ return b[0]-a[0]; }});
  var anns = [], adjY = [];
  var lastDate = seriesArr[0].dates[seriesArr[0].dates.length-1];
  for (var li=0; li<allSeries.length; li++) {{
    var y = allSeries[li][0];
    ...
    anns.push({{
      ...
      text: '<b>'+allSeries[li][1]+'</b>',
      showarrow: false,
      font: {{ size: 13.5, color: allSeries[li][2], family: 'Inter,sans-serif' }},
...
function buildTraces(seriesArr) {{
  var traces = [];
  for (var i=0; i<seriesArr.length; i++) {{
    var s = seriesArr[i];
    var lineStyle = s.is_sp
      ? {{ color: s.color, width: 2.5, dash: 'dashdot', shape: 'spline', smoothing: 0.7 }}
      : {{ color: s.color, width: 3, shape: 'spline', smoothing: 0.7 }};
    traces.push({{
...
function renderChart(seriesArr) {{
  var traces = buildTraces(seriesArr);
  currentAnnotations = buildAnnotations(seriesArr);
  ...
  Plotly.newPlot('line-chart', traces, {{
    ...
    xaxis: {{
      ...
      color: '#374151',
      tickfont: {{ size: isMobile?9:13, color: '#374151', family: 'Inter,sans-serif' }},
      zeroline: false, showline: true, linecolor: '#cbd5e1', tickcolor: '#94a3b8',
      automargin: true, tickangle: isMobile?-55:-45,
      range: [-0.8, seriesArr[0].dates.length - 0.8]
    }},
    yaxis: {{
    ...
    annotations: isMobile ? [] : currentAnnotations,
    margin: isMobile ? {{ t:40, b:60, l:55, r:10 }} : {{ t:60, b:80, l:155, r:210 }},
    legend: {{
      orientation: 'h', yanchor: 'bottom', y: 1.02,
      xanchor: 'center', x: 0.5,
      font: {{ color: '#374151', size: isMobile?10:15, family: 'Inter,sans-serif' }},
...
// ── Dropdown handler ───────────────────────────────────────────────
function switchBaseline(val) {{
  var titleEl = document.getElementById('chart-title');
  if (val === 'may') {{
    renderChart(mayData);
    if (titleEl) titleEl.innerHTML = '&#128198; Cumulative Portfolio Value vs S&amp;P 500 (May 1 &ndash; present)';
  }} else {{
    renderChart(febData);
    if (titleEl) titleEl.innerHTML = '&#128200; Cumulative Portfolio Value vs S&amp;P 500 ({range_label})';
  }}
}}

// Initial render with May baseline
renderChart(mayData);
if (document.getElementById('chart-title')) {{
  document.getElementById('chart-title').innerHTML = '&#128198; Cumulative Portfolio Value vs S&amp;P 500 (May 1 &ndash; present)';
}}

function adjustForMobile() {{
  var sel = document.getElementById('baseline-select');
  var seriesArr = (sel && sel.value === 'feb') ? febData : mayData;
  var isMobile = window.innerWidth < 600;
